#############################################################################
# Makefile for building: lidar_calibration
# Generated by qmake (2.01a) (Qt 4.8.7) on: ?? 2? 15 15:50:31 2019
# Project:  test.pro
# Template: app
...
DIST          = /usr/share/qt4/mkspecs/common/unix.conf \
		...
		test.pro
QMAKE_TARGET  = lidar_calibration
DESTDIR       = 
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/lidar_calibration1.0.0 || $(MKDIR) .tmp/lidar_calibration1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/lidar_calibration1.0.0/ && $(COPY_FILE) --parents mainwindow.h addlidardialog.h lidar_driver/driver.h lidar_driver/input.h lidar_driver/rawdata.h lidar_driver/lidar.h .tmp/lidar_calibration1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp addlidardialog.cpp lidar_driver/driver.cpp lidar_driver/input.cpp lidar_driver/rawdata.cpp lidar_driver/lidar.cpp .tmp/lidar_calibration1.0.0/ && $(COPY_FILE) --parents mainwindow.ui addlidardialog.ui .tmp/lidar_calibration1.0.0/ && (cd `dirname .tmp/lidar_calibration1.0.0` && $(TAR) lidar_calibration1.0.0.tar lidar_calibration1.0.0 && $(COMPRESS) lidar_calibration1.0.0.tar) && $(MOVE) `dirname .tmp/lidar_calibration1.0.0`/lidar_calibration1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/lidar_calibration1.0.0
